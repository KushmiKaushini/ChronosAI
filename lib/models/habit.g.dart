...
void _habitSerialize(
  ...
  writer.writeLongList(offsets[7], object.targetDays);
...
Habit _habitDeserialize(
  ...
  final object = Habit(
    ...
    lastCompletedDate: reader.readDateTimeOrNull(offsets[3]),
    longestStreak: reader.readLongOrNull(offsets[4]) ?? 0,
    status: reader.readStringOrNull(offsets[5]) ?? 'active',
    streakCount: reader.readLongOrNull(offsets[6]) ?? 0,
    targetDays: reader.readLongList(offsets[7]) ?? [],
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> statusStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> statusEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> statusContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'status',
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> statusMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> statusIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'status',
        value: '',
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> statusIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'status',
        value: '',
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, String, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
